...
public class AutoUpdator : MonoBehaviour {
    ...
    // these are the variables you can see in unity
    public GUISkin myskin;
    public string GameVersion = "none", fileFormat = ".exe", securityCode = "";
    public string urlVersion = "" , urlUpdate = "";    // most important part but we have to check the update
    // dont wanna make a new update exe, but maybe its getting it from the site
    ...
    public string UPTODATESCENE = "" , CancelScene = "";
